        ...
        <section className={`${styles.why} section`} aria-labelledby="why-title">
            ...
            <div className={styles.content}>
                ...
                <div className={styles.text}>
                    <p>
                        За кожним магазином стоять не лише речі, а й роки пошуку постачальників, контактів та
                        домовленостей.
                    </p>
                    <p>
                        Ця база формувалася протягом кількох років вивчення ринку жіночого одягу та роботи з
                        українськими виробниками й постачальниками.
                    </p>

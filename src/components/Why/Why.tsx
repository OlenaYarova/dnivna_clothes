        ...
        <section className={`${styles.why} section`} aria-labelledby="why-title">
            ...
            <div className={styles.content}>
                ...
                <div className={styles.text}>
                    <p>За кожним магазином стоять не лише речі, а й роки пошуку постачальників, контактів та домовленостей.</p>
                    <p>Ця база формувалася протягом кількох років вивчення ринку жіночого одягу та роботи з українськими виробниками й постачальниками.</p>
                    <p>Частина постачальників із цієї бази використовується в роботі магазину DNIVNA.</p>
                    <p>Я не продаю курсів і не навчаю бізнесу.</p>
                    <p>Я ділюся результатом власного досвіду, пошуку та роботи з ринком жіночого одягу.</p>
                </div>
